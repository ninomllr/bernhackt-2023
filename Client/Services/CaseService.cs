...
public class CaseService : ICaseService
{
	private List<Case> _list = new() {
		...
		new Case() { CaseNumber = 3, CaseName = "Test 3", Address = "Lindenhofstrasse 1, 3048 Ittigen", Lat = 46.979641, Lng = 7.460920, CustomerName = "Hans Muster", Date = DateTime.Now, Bounty = null},
	};
